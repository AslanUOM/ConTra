...
public class EnvironmentResourceTest {
    ...
    public void testCreate() throws Exception {
        ...
        assertEquals("Environment is not created", temp.doubleValue(), 25.0, 0.0);
    }
    ...
    public void testUpdateWithIncreasedAccuracy() throws Exception {
        ...
        response = HTTP.POST(server.httpURI().resolve("/contra/environment/create").toString(), userEnvironment);
        ...
        assertEquals("Environment is not updated with higher frequency", temp.doubleValue(), 20.0, 0.0);
    }
    ...
    public void testUpdateWithDecreasedAccuracy() throws Exception {
        ...
        assertEquals("Environment is updated with lower frequency", temp.doubleValue(), 21.0, 0.0);
    }
}
